...
require_once READ_PATH . 'property.php';
require_once READ_PATH . 'employee.php';
require_once READ_PATH . 'expense.php';
require_once READ_PATH . 'invoice.php';
require_once READ_PATH . 'dates.php';
require_once READ_PATH . 'simple.php';
require_once READ_PATH . 'user.php';
require_once READ_PATH . 'landlord.php';
